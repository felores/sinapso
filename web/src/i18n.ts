...
const EN: Dict = {
  ...
  "qmd.busyBody": "Wait for the current qmd job to finish, then run Full Re-embed again.",
...
const ES: Dict = {
  ...
  "qmd.updateTitle": "Reindexar notas cambiadas para búsqueda por palabra clave (qmd update)",
  ...
  "qmd.busyBody": "Espera a que termine el trabajo actual de qmd y vuelve a ejecutar la revectorización completa.",
