...
const EN: Dict = {
  ...
  "ph.tinyfishKey": "Tinyfish API key — paste + Enter",
  ...
  "ingest.processing": "Ingesting source…",
  "ingest.processingFile": "Ingesting {name}…",
  "ingest.saved": "Saved to Inbox",
  "ingest.savedPinned": "Saved to Inbox; the pinned item stayed open.",
  "ingest.openFailed": "Saved, but the Inbox note could not be opened.",
  ...
  "related.finding": "finding related notes...",
  "related.empty": "no related notes found",
  "related.unavailable": "related notes unavailable (semantic search error)",
  ...
  "link.openExternal": "Open original link in new tab",
  "research.fetching": "fetching the full article…",
  "research.processingResource": "Processing resource…",
  "research.resourceFailed": "Could not process resource",
  "research.deepBusy":
  ...
  "q.title": "Research questions",
  "q.empty": "no questions for this note",
...
const ES: Dict = {
  ...
  "ph.tinyfishKey": "Clave API de Tinyfish: pegar + Enter",
  ...
  "ingest.processing": "Ingiriendo fuente…",
  "ingest.processingFile": "Ingiriendo {name}…",
  "ingest.saved": "Guardado en Inbox",
  "ingest.savedPinned":
    "Guardado en Inbox; se mantuvo abierto el elemento fijado.",
  "ingest.openFailed": "Se guardó, pero no se pudo abrir la nota de Inbox.",
  "ingest.failed": "Falló la ingesta.",
  ...
  "related.semantic": "semántica",
  "related.finding": "buscando notas relacionadas...",
  "related.empty": "no se encontraron notas relacionadas",
  "related.unavailable":
    "notas relacionadas no disponibles (error de búsqueda semántica)",
  ...
  "link.openExternal": "Abrir enlace original en una pestaña nueva",
  "research.fetching": "trayendo el artículo completo…",
  "research.processingResource": "Procesando recurso…",
  "research.resourceFailed": "No se pudo procesar el recurso",
  "research.deepBusy":
  ...
  "q.title": "Preguntas de investigación",
  "q.empty": "no hay preguntas para esta nota",
