...
const EN: Dict = {
  ...
  "ingest.alreadyWiki": "In Wiki folder",
  "ingest.rawInWiki": "RAW source in Wiki",
  "ingest.noWiki": "No enabled wiki",
  "ingest.rawPending": "RAW source — not yet ingested",
  ...
  "inbox.review.run": "Review Inbox",
  "inbox.review.running": "reviewing Inbox…",
  "inbox.review.loaded": "Inbox Review found {count} suggestion(s).",
  "inbox.review.failed": "Inbox Review failed. Retry.",
  "inbox.review.back": "Back to Inbox",
  "inbox.review.refresh": "Refresh Review",
  "inbox.review.emptyInbox":
    "The Inbox is empty. Add a note before reviewing it.",
  "inbox.review.emptySuggestions":
    "No conservative local suggestions were found. No AI inspected these notes.",
  "inbox.review.action.continue": "Continue",
  "inbox.review.action.link": "Link",
  "inbox.review.action.merge": "Merge",
  "inbox.review.action.archive": "Archive",
  "inbox.review.action.ingest": "Ingest",
  "inbox.review.reason.unchecked": "Contains an unchecked task.",
  "inbox.review.reason.todo": "Contains an explicit TODO or FIXME marker.",
  "inbox.review.reason.heading": "Ends with a heading that has no body.",
  "inbox.review.reason.empty": "The note is empty.",
  "inbox.review.reason.duplicate": "Exact duplicate of {target}.",
  "inbox.review.reason.title": "Normalized title matches {target}.",
  "inbox.review.reason.similarity": "Cached semantic similarity is {score}.",
  "inbox.review.reason.neighbor": "Cached semantic neighbor: {target}.",
  "inbox.review.reason.ingest": "Choose an enabled wiki to propose ingestion.",
  "inbox.review.target": "Target: {target}",
  "inbox.review.cardLabel": "{action} suggestion for {title}",
  "inbox.review.preview": "Complete merged Markdown preview",
  "inbox.review.commentPlaceholder": "Optional review comment",
  "inbox.review.commentLabel": "Review comment",
  "inbox.review.commentSave": "Save comment",
  "inbox.review.commentSaveLabel": "Save review comment for {title}",
  "inbox.review.commentSaved": "Comment saved",
  "inbox.review.commentFailed": "Retry comment",
  "inbox.review.approve": "Approve",
  "inbox.review.approveLabel": "Approve {action} for {title}",
  "inbox.review.dismiss": "Dismiss",
  "inbox.review.dismissLabel": "Dismiss {action} for {title}",
  "inbox.review.dismissed": "Suggestion dismissed.",
  "inbox.review.approved": "Approved",
  "inbox.review.applying": "applying…",
  "inbox.review.stale": "Stale, refresh",
  "inbox.review.staleMessage": "This note or target changed. Refresh Review.",
  "inbox.review.applyFailed": "Could not apply this suggestion. Retry.",
  "inbox.review.blockedEditor":
    "This note has unsaved, saving, conflicted, or failed edits. Resolve them before applying this action.",
  "inbox.review.confirm.link": "Append the shown wikilink to this note?",
  "inbox.review.confirm.merge":
    "Replace the target with the complete preview? The source remains unchanged.",
  "inbox.review.confirm.archive":
    "Move this note to the configured archive folder?",
  "inbox.review.noWiki": "No enabled wiki is available.",
  "inbox.review.chooseWiki": "Choose a wiki",
  "inbox.review.proposeIngest": "Prepare proposal",
...
const ES: Dict = {
  ...
  "ingest.alreadyWiki": "En carpeta Wiki",
  "ingest.rawInWiki": "Fuente raw en Wiki",
  "ingest.noWiki": "No hay wiki activa",
  "ingest.rawPending": "Fuente RAW — sin ingerir",
  ...
  "inbox.review.run": "Revisar Inbox",
  "inbox.review.running": "revisando Inbox…",
  "inbox.review.loaded": "La revisión encontró {count} sugerencia(s).",
  "inbox.review.failed": "Falló la revisión de Inbox. Reintenta.",
  "inbox.review.back": "Volver a Inbox",
  "inbox.review.refresh": "Actualizar revisión",
  "inbox.review.emptyInbox":
    "Inbox está vacío. Agrega una nota antes de revisarlo.",
  "inbox.review.emptySuggestions":
    "No se encontraron sugerencias locales conservadoras. Ninguna IA inspeccionó estas notas.",
  "inbox.review.action.continue": "Continuar",
  "inbox.review.action.link": "Enlazar",
  "inbox.review.action.merge": "Combinar",
  "inbox.review.action.archive": "Archivar",
  "inbox.review.action.ingest": "Ingerir",
  "inbox.review.reason.unchecked": "Contiene una tarea sin marcar.",
  "inbox.review.reason.todo": "Contiene un marcador TODO o FIXME explícito.",
  "inbox.review.reason.heading": "Termina con un encabezado sin contenido.",
  "inbox.review.reason.empty": "La nota está vacía.",
  "inbox.review.reason.duplicate": "Duplicado exacto de {target}.",
  "inbox.review.reason.title": "El título normalizado coincide con {target}.",
  "inbox.review.reason.similarity":
    "La similitud semántica en caché es {score}.",
  "inbox.review.reason.neighbor": "Vecino semántico en caché: {target}.",
  "inbox.review.reason.ingest":
    "Elige una wiki habilitada para proponer la ingesta.",
  "inbox.review.target": "Destino: {target}",
  "inbox.review.cardLabel": "Sugerencia de {action} para {title}",
  "inbox.review.preview": "Vista previa completa del Markdown combinado",
  "inbox.review.commentPlaceholder": "Comentario opcional de revisión",
  "inbox.review.commentLabel": "Comentario de revisión",
  "inbox.review.commentSave": "Guardar comentario",
  "inbox.review.commentSaveLabel":
    "Guardar comentario de revisión para {title}",
  "inbox.review.commentSaved": "Comentario guardado",
  "inbox.review.commentFailed": "Reintentar comentario",
  "inbox.review.approve": "Aprobar",
  "inbox.review.approveLabel": "Aprobar {action} para {title}",
  "inbox.review.dismiss": "Descartar",
  "inbox.review.dismissLabel": "Descartar {action} para {title}",
  "inbox.review.dismissed": "Sugerencia descartada.",
  "inbox.review.approved": "Aprobada",
  "inbox.review.applying": "aplicando…",
  "inbox.review.stale": "Desactualizada, refresca",
  "inbox.review.staleMessage":
    "Esta nota o destino cambió. Actualiza la revisión.",
  "inbox.review.applyFailed": "No se pudo aplicar esta sugerencia. Reintenta.",
  "inbox.review.blockedEditor":
    "Esta nota tiene cambios sin guardar, guardándose, en conflicto o con error. Resuélvelos antes de aplicar esta acción.",
  "inbox.review.confirm.link": "¿Agregar el wikilink mostrado a esta nota?",
  "inbox.review.confirm.merge":
    "¿Reemplazar el destino con la vista previa completa? La fuente permanecerá sin cambios.",
  "inbox.review.confirm.archive":
    "¿Mover esta nota a la carpeta de archivo configurada?",
  "inbox.review.noWiki": "No hay una wiki habilitada disponible.",
  "inbox.review.chooseWiki": "Elegir una wiki",
  "inbox.review.proposeIngest": "Preparar propuesta",
